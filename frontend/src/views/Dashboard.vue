<template>
    ...
    <div class="min-h-full">
          ...
          <div class="flex h-16 items-center justify-between">
            <div class="flex items-center">
              <div class="flex-shrink-0">
                <img class="h-8 w-8" src="/logo.png" alt="VirAi" />
              </div>
      ...
      <FakeNotifcations></FakeNotifcations>
...
import WorkerSummary from '../components/Stat-Summary.vue';
import Footer from '../components/Footer.vue';
import FakeNotifcations from '../components/FakeNotifications.vue';
